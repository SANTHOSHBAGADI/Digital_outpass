...
if ($selected_department === 'all') {
    $log_query = "SELECT lb.id, lb.request_id, lb.student_id, lb.log_time, s.department 
                  FROM log_book lb 
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $log['log_time'] ? htmlspecialchars($log['log_time']) : '-'; ?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php if (empty($log_book)): ?>
                        <tr><td colspan="5">No log book entries found for this department.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
