...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_student'])) {
    ...
    $delete_query = "DELETE FROM students WHERE student_id = ? AND department = ?";
    $stmt = mysqli_prepare($conn, $delete_query);
    mysqli_stmt_bind_param($stmt, "ss", $student_id, $admin_department);
...
// Handle approve/reject actions (unchanged from original)
...
<body>
    <!-- Loader, Sidebar, Profile Modal remain unchanged -->
